...
import com.muyaho.hyojason.databinding.ActivityChatBinding;
import com.muyaho.hyojason.model.MessageData;
import com.muyaho.hyojason.model.RoomData;
import com.muyaho.hyojason.retrofit.Result;
import com.muyaho.hyojason.retrofit.RetrofitClient;
        ...
        runOnUiThread(() -> {
            if (data.getType().equals("ENTER") || data.getType().equals("LEFT")) {
                ...
                if (data.getFrom().equals(username)) {
                    adapter.addItem(new ChatItem(data.getFrom(), data.getContent(), toDate(data.getSendTime()), ChatType.RIGHT_IMAGE));
                }
                else{
